...
When needing to set some extra content in the entry file, for example, set `__webpack_public_path__` to config [webpack#publicPath](https://webpack.js.org/guides/public-path/#on-the-fly).
